...
%---------------------------------------------------------
\cventry
{Back-end implementer} % Job title
{Hack\&Roll Hackathon 2016} % Organization
{NUS, Singapore} % Location
{Jan. 2016} % Date(s)
{
	\begin{cvitems} % Description(s) of tasks/responsibilities
		\item {Devised an algorithm to automatically create a NUS timetable based on certain constraints.}
		\item {Implemented the algorithm with plain Javascript.}
...
\cventry
{Developer} % Job title
{Bloghub} % Organization
{} % Location
{Dec. 2015} % Date(s)
{
	\begin{cvitems} % Description(s) of tasks/responsibilities
		\item {A simple website for blogs made in PHP and MySQL}
		\item {Github repository: https://github.com/donjar/cvwo-assignment-1}
	\end{cvitems}
}
